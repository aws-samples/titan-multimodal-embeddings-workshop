...
def createEncryptionPolicy(client, collection_name):
    ...
    try:
        response = client.create_security_policy(
            description="Encryption policy for {} collection".format(collection_name),
...
def createNetworkPolicy(client, collection_name):
    ...
    try:
        response = client.create_security_policy(
            description="Network policy for {} collection".format(collection_name),
            name="{}-policy".format(collection_name),
            policy="""
                [{
...
def createAccessPolicy(client, collection_name, identity_arn):
    ...
    try:
        ...
        response = client.create_access_policy(
            description='Data access policy for {} collection'.format(collection_name),
            name="{}-policy".format(collection_name),
            policy=policy,
            type='data'
        )
